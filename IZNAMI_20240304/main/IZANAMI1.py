...
try:
    ...
    variable = tkinter.StringVar ( ) #A~Dが文字列の場合
    if("Windows"==g_val.OS_VERSION):
        combo_mode = ttk.Combobox ( init_mode_f ,width=30,height=9, values = g_val.mode_list , textvariable = variable,state="readonly")
    else:
        combo_mode = ttk.Combobox ( init_mode_f ,width=20,height=9, values = g_val.mode_list , textvariable = variable,state="readonly")
    ...
    # text_ng_dword_f=ttk.Label(
    #                 ,anchor=tkinter.E,justify="left")
